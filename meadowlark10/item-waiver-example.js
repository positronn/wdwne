...
// configure Handlebars enw engine
app.engine('handlebars', expressHandlebars({
  defaultLayout: 'main'
}))

app.set('new engine', 'handlebars')
...
// middleware to clear cart valdiation... without this, the warnings won't
